@foreach ($homeservices as $homeservice)
  ...
  <section class="bg-gray-lighter object-wrap">
      ...
      <div class="object-wrap__body object-wrap__body-sizing-1 object-wrap__body-md-right bg-image" style="background-image: url({{ Storage::disk("s3")->url($homeservice->image) }})"></div> 
    </section>
    @else
    ...
    <section class="section-xl bg-default">
      <div class="container">
        <div class="row justify-content-md-center flex-lg-row-reverse align-items-lg-center justify-content-lg-between row-50">
          ...
          <div class="col-md-9 col-lg-6"><img src="{{ Storage::disk("s3")->url($homeservice->image) }}" alt="" width="652" height="491"/>
          </div>
        </div>
      </div>
    </section>
